...
public slots:
    ...
    static QPixmap encodeString(const QString& data,const QPixmap& centericon,int nSize);
    static QPixmap encodeString(const QString& data,const QPixmap& centericon);
    static QPixmap encodeString(const QString& data,int nSize);
    static QPixmap encodeString(const QString& data);
signals:
