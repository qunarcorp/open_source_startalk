...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DemoDialog_t, stringdata) + ofs \
...
const QMetaObject DemoDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DemoDialog.data,
      qt_meta_data_DemoDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DemoDialog.stringdata))
