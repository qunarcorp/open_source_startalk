...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QRCodeWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 11)
    ...
    "QRCodeWidget\0onGrabQRcode\0\0currentLoop\0"
};
...
void QRCodeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QRCodeWidget *_t = static_cast<QRCodeWidget *>(_o);
        switch (_id) {
        case 0: _t->onGrabQRcode((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject QRCodeWidget::staticMetaObject = {
    { &LocalManWidget::staticMetaObject, qt_meta_stringdata_QRCodeWidget.data,
      qt_meta_data_QRCodeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QRCodeWidget.stringdata))
