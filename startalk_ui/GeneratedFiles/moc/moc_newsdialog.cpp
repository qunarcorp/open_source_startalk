...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NewsDialog_t, stringdata) + ofs \
...
const QMetaObject NewsDialog::staticMetaObject = {
    { &ChatDialog::staticMetaObject, qt_meta_stringdata_NewsDialog.data,
      qt_meta_data_NewsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewsDialog.stringdata))
