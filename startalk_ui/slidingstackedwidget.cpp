...
void SlidingStackedWidget::slideInWidget(QWidget* newwidget,enum t_direction direction/*=AUTOMATIC*/)
{
    direction=m_vertical ? TOP2BOTTOM : direction;
    slideInWgt(newwidget,direction);
}
